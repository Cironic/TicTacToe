...
//    public void appendDataToCSV(List<Point> points) {
//        try (CSVWriter writer = new CSVWriter(new FileWriter(filePath, true))) {
//            for (Point point : points) {
//                String[] row = {String.valueOf(point.getX()), String.valueOf(point.getY())};
//                writer.writeNext(row);
//            }
//            System.out.println("Die Daten wurden erfolgreich zur CSV-Datei hinzugefügt: " + filePath);
//        } catch (IOException e) {
//            System.out.println("Fehler beim Hinzufügen von Daten zur CSV-Datei: " + e.getMessage());
//        }
//    }
